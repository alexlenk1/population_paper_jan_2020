...
rng(100); % setting random seed for reproducibility
...
tabel=zeros(39,7);   % matrix containing output for tables
...
for simulation_design=1:7
    ...
    theta_causal=mean(theta); % This is implied by formula (3.5) since X,Z standard normal and uncorrelated
    ...
    for isim=1:Nsim
        ...
        theta_causal_sample=mean(theta(R,1)); % This is implied by formula (3.5) since X,Z standard normal and uncorrelated
        ...
        hat_theta=beta_hat(1,1);    % Remember that theta_hat = theta_tilde (where theta_tilde obtained in a regression of YR on UR and ZR)
        ...
        out(isim,:)=[se_ehw,se_desc,se_causal_sample,se_causal,se_Z_causal_sample,se_Z_causal,se_hat_ehw,se_hat_boot,se_hat_desc,se_hat_causal_sample,se_hat_causal];
        ...
        coverage(isim,:)=[in_ehw,in_desc,in_causal_sample,in_causal,in_Z_causal_sample,in_Z_causal,in_hat_ehw,in_hat_boot,in_hat_desc,in_hat_causal_sample,in_hat_causal];
